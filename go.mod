module github.com/santoshkal/gpusim-scheduler
...
// k8s.io/kubernetes references every staging repo at v0.0.0. Consumers must
// pin each one to the matching published release. Keep this block in lockstep
// with the k8s.io/kubernetes version above.
replace (
